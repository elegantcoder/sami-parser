...
(function() {
  var clone, cssParse, langCodes, reBr, reBrokenTag, reCloseSync, reComment, reLineEnding, reOpenSync, reStartTime, reStyle, _makeEndTime, _mergeMultiLanguages, _sort;
  ...
  _makeEndTime = function(langItem) {
    var i, item, _ref;
    i = langItem.length;
    while (i--) {
      item = langItem[i];
  ...
  module.exports = function(sami, options) {
    var definedLangs, errors, getDefinedLangs, getLanguage, key, parse, result, value, _ref;
    parse = function() {
